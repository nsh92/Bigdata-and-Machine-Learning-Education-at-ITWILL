...
rating = pd.read_csv('C:/ITWILL/4_Python-II/data/movie_rating.csv')
print(rating.info())

grp_movie = rating['rating'].groupby([rating['critic'], rating['title']])
grp_movie_sum = grp_movie.sum()
grp_movie_sum_2d = grp_movie_sum.unstack()
print(grp_movie_sum_2d)
