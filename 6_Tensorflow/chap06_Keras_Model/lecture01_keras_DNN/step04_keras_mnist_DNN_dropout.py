# -*- coding: utf-8 -*-
"""
step04_keras_mnist_DNN_dropout.py

Keras + MNIST(0~9) + Flatten layer + History + Dropout
...
# step3에서 뽑은 거에 비해서 더 가까워짐
# 드롭아웃 비율도 절대적인 것이 아니라서 잘 정해야 함
# 절대적인 것이 있다면 해당하는 층의 네트워크의 수에 비례하도록 하는 점이 있음
