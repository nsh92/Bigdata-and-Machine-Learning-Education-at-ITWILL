...
select name, pay, bonus, pay+nvl2(bonus, bonus, 0) from professor;
내가 푼거
select name, pay, bonus,nvl(bonus, pay*12+bonus, pay*12) as 연봉 from professor;
교수님 푼거
...
select name 교수명, decode(deptno, 101, '컴퓨터공학과',
                            102, '멀티디미어 공학과',
                            103, '소프트웨어 공학과', '기타학과') 학과명 from professor;